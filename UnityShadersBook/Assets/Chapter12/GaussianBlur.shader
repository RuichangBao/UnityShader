    ...
    SubShader
    {
        ...
        Pass //竖直方向模糊
        {
            ...
            v2f vert (a2v v)
            {
                ...
                o.uv[2] = uv + _MainTex_TexelSize * half2(0, -1) * _BlurSize;
                o.uv[3] = uv + _MainTex_TexelSize * half2(0, 2) * _BlurSize;
        ...
        Pass//水平方向模糊
        {
            ...
            v2f vert (a2v v)
            {
                ...
                o.uv[2] = uv + _MainTex_TexelSize * half2(-1, 0) * _BlurSize;
                o.uv[3] = uv + _MainTex_TexelSize * half2(2, 0) * _BlurSize;
