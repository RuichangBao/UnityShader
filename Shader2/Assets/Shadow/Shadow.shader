    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f o) : SV_Target
            {
                ...
                float3 specular = _LightColor0.rgb * _Specular * pow(max(0, dot(worldNormal, halfDir)), _Gloss);
                UNITY_LIGHT_ATTENUATION(atten, o, worldPos);
                fixed3 color = (textureCol * diffuse + specular) * atten ;
